...
import com.lebrwcd.blog.dao.CommentDao;
import com.lebrwcd.blog.entity.Comment;
import com.lebrwcd.blog.service.CommentService;
...
public class CommentServiceImpl implements CommentService {
    ...
    public int saveComment(Comment comment,Comment parentComment) {
        ...
        if(!StringUtils.isEmpty(parentComment)){
            ...
            simpleMailMessage.setFrom("132923760@qq.com");//发送者邮箱
